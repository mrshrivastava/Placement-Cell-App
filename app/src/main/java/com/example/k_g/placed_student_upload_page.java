...
public class placed_student_upload_page extends AppCompatActivity {
    ...
    private EditText mEditTextbatch, mEditTextbranch, mEditTextcontact, mEditTextpkg, mEditTextcompany, mEditTextname;
    private int check=0;
    private int s=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTextcontact=findViewById(R.id.contact);
        ...
        mButtonUpload.setOnClickListener(view -> {
            if(mEditTextbranch.getText().toString().trim().equalsIgnoreCase("") ||
                    mEditTextbatch.getText().toString().trim().equalsIgnoreCase("") ||
                    mEditTextcompany.getText().toString().trim().equalsIgnoreCase("") ||
                    mEditTextcontact.getText().toString().trim().equalsIgnoreCase("") ||
                    mEditTextname.getText().toString().trim().equalsIgnoreCase("") ||
        ...
        fileReference.putFile(img)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(placed_student_upload_page.this, "Upload Successful", Toast.LENGTH_SHORT).show();
                        Task<Uri> uri = taskSnapshot.getStorage().getDownloadUrl();
                        while(!uri.isComplete());
                        Uri url = uri.getResult();
                        Log.d("Hello","this is the link->"+url.toString());
                        Placed_Student_Uploadmodel uploadmodel=new Placed_Student_Uploadmodel(mEditTextbatch.getText().toString().trim(),
                                mEditTextbranch.getText().toString().trim(),
                                mEditTextcompany.getText().toString().trim(),
                                mEditTextcontact.getText().toString().trim(),
                                url.toString(),
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(placed_student_upload_page.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
